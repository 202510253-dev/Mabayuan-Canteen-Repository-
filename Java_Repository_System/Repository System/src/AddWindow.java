...
public class AddWindow extends JDialog {
    ...
    public AddWindow(Repository parent) {
        super(parent.frame, "Add New Product", true);
        this.parent = parent;
    ...
    private void handleAdd() {
        ...
        try {
            ...
            try (Connection conn = DatabaseConnection.getConnection()) {
                String sql = "INSERT INTO products_table (Item_name, Item_price, Item_quantity, Item_category) VALUES (?, ?, ?, ?)";
